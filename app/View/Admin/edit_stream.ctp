<div class="row">
    ...
    <div class="col-md-9">
        <h2 class="first">Een stramien wijzigen</h2>
        <h3><?php echo $employee["Employee"]["name"] . ' ' . $employee["Employee"]["surname"];?></h3>
        <?php echo $this->Form->create('Stream', array('url' => $this->here));?>
        <!-- Controls -->
        <input type="hidden" name="data[Stream][employee_id]" value="<?php echo $employee["Employee"]["internal_id"];?>">
        <!-- Form -->
...
<script>
    var json = <?php echo json_encode($streams);?>;
</script>