<div class="row">
    ...
    <div class="col-md-9">
        ...
        <div class="row"><div class="col-md-6"><h4>Aantal dagen verbruikt: <?php echo ($employee["Employee"]["daysleft"] - $prevCost) / 2;?></h4></div><div class="col-md-6"><?php echo $this->Form->input('daysleft', array('label' => false, 'class' => 'form-control spaced', 'placeholder' => 'Aantal halve verlofdagen per jaar ', 'value' => $employee["Employee"]["daysleft"]));?></div></div>
