	...
	public function importCSV(Model &$Model, $file, $fixed = array(), $returnSaved = false) {
		...
		while (($row = $this->_getCSVLine($Model, $handle)) !== false) {
			...
			foreach ($header as $k => $col) {
                ...
                $data["Employee"]["role_id"] = 1;
                $data["Employee"]["employee_department_id"] = (int)$data["Employee"]["employee_department_id"];
                $data["Employee"]["supervisor_id"] = (int)$data["Employee"]["supervisor_id"];
                $data["Employee"]["daysleft"] = (float)$data["Employee"]["daysleft"];
